...
from triton import ARCH, TritonContext, REG, CPUSIZE, MemoryAccess, Instruction, OPCODE
...
def __malloc():
    ...
    # Get arguments
    size = Triton.getConcreteRegisterValue(Triton.Register(REG.X86_64.RDI))
...
def __printf_chk():
    ...
    # Get arguments
    arg1   = Triton.getConcreteRegisterValue(Triton.Register(REG.X86_64.RDI))
    arg2   = getFormatString(Triton.getConcreteRegisterValue(Triton.Register(REG.X86_64.RSI)))
...
def __fgets():
    ...
    for c in user:
        ...
        Triton.setConcreteMemoryValue(mem)
        indx += 1
