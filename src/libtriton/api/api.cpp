...
namespace triton {
  ...
  void API::setConcreteSymbolicVariableSize(const triton::engines::symbolic::SymbolicVariable& symVar) {
    this->checkSymbolic();
    return this->symbolic->setConcreteSymbolicVariableSize(symVar);
  }
