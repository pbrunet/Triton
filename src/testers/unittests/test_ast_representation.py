...
class TestAstRepresentation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.node = [
            ...
            (self.astCtxt.extract(7, 0, self.v1),            "((_ extract 7 0) SymVar_0)",           "(SymVar_0 & 0xFF)"),
            (self.astCtxt.ite(self.v1, self.v1, self.v2),    "(ite SymVar_0 SymVar_0 SymVar_1)",     "(SymVar_0 if SymVar_0 else SymVar_1)"),
            (self.astCtxt.land(self.v1, self.v2),            "(and SymVar_0 SymVar_1)",              "(SymVar_0 and SymVar_1)"),
